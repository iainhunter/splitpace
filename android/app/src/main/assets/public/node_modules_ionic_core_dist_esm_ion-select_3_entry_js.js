...
const Select = class {
  ...
  connectedCallback() {
    ...
    return (0,_Users_ih_admin_Documents_splitpace_new_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.mutationO = watchForOptions(_this.el, 'ion-select-option', /*#__PURE__*/(0,_Users_ih_admin_Documents_splitpace_new_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        _this.updateOverlayOptions();
        /**
